<template>
  <div class="Index_bgImg">
    ...
    <div style="position: relative;top: 13rem;">
      ...
      <span style="position: absolute;top:1.6rem;left: 5rem;font-size: 18px;font-family:PingFang-SC;color:rgba(255,255,255,1);">历史噪声趋势</span>
